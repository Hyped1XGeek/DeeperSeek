...
class DeepSeekSelectors:    
    ...
    # Interactions
    textbox_css = 'textarea[id="chat-input"]'
    send_options_parent_css = 'div[class="ec4f5d61"]'
    send_button_css = 'div[class="_6f28693"]'
    ...
    response_generating_css = 'div[class="ds-loading b4e4476b"]'
    response_generated_css = 'div[class="_6f28693"] div[class="ds-icon"]'
