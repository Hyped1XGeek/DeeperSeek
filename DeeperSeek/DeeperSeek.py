...
class DeepSeek:
    ...
    async def _login(self) -> None:
        ...
        try:
            ...
            await self.browser.main_tab.wait_for(DSS.textbox_css, timeout=10)  # Increase timeout to 15 seconds
        except:
    ...
    async def _get_response(self, timeout: int = 60, regen: bool = False) -> Optional[Response]:
        ...
        soup = BeautifulSoup(repr(response_generated[-1]), 'html.parser')
        response_text = str(await self.browser.main_tab.evaluate("""
(function() {
